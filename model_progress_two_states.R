...
eac_model <- function(
  ...
  # Allow for faster progression 
  
  prob_gerd_prog2 <- (prob_gerd_prog*prob_ndbe_prog)/2
  prob_gerd_prog1 <- prob_gerd_prog - prob_gerd_prog2
  
  prob_ndbe_prog2 <- (prob_ndbe_prog*prob_lgdbe_prog)/2
  prob_ndbe_prog1 <- prob_ndbe_prog - prob_ndbe_prog2
  
  prob_lgdbe_prog2 <- (prob_lgdbe_prog*prob_hgdbe_prog)/2
  prob_lgdbe_prog1 <- prob_lgdbe_prog - prob_lgdbe_prog2
  
  prob_hgdbe_prog2 <- (prob_hgdbe_prog*prob_eac1_prog)/2
  prob_hgdbe_prog1 <- prob_hgdbe_prog - prob_hgdbe_prog2
  ...
  for (i in 1:12) {
    ...
    ns$gerd[j] <- (ns$gerd[i]*(1-prob_death[i]))*(1-prob_gerd_prog1-prob_gerd_prog2)
    ns$ndbe[j] <- ((ns$ndbe[i]*(1-prob_death[i]))*(1-prob_ndbe_prog1-prob_ndbe_prog2))+((ns$gerd[i]*(1-prob_death[i]))*prob_gerd_prog1)
    ns$lgdbe[j] <- ((ns$lgdbe[i]*(1-prob_death[i]))*(1-prob_lgdbe_prog1-prob_lgdbe_prog2))+((ns$ndbe[i]*(1-prob_death[i]))*prob_ndbe_prog1)+((ns$gerd[i]*(1-prob_death[i]))*prob_gerd_prog2)
    ns$hgdbe[j] <- ((ns$hgdbe[i]*(1-prob_death[i]))*(1-prob_hgdbe_prog1-prob_hgdbe_prog2))+((ns$lgdbe[i]*(1-prob_death[i]))*prob_lgdbe_prog1)+((ns$ndbe[i]*(1-prob_death[i]))*prob_ndbe_prog2)
    ...
    ns$und_eac1_a[j] <- ((ns$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog1)+((ns$lgdbe[i]*(1-prob_death[i]))*prob_lgdbe_prog2)
    ...
    ns$eac2_a[j] <- ((((ns$und_eac1_a[i]+ns$und_eac1_b[i])*(1-prob_eac1_diag))+ns$und_eac1_c[i]+ns$und_eac1_d[i])*(1-prob_death[i])*prob_eac1_prog)+((ns$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog2)
  ...
  for (i in 1:12) {
    ...
    gerd_ns$gerd[j] <- (gerd_ns$gerd[i]*(1-prob_death[i]))*(1-prob_gerd_prog1-prob_gerd_prog2)
    gerd_ns$ndbe[j] <- ((gerd_ns$ndbe[i]*(1-prob_death[i]))*(1-prob_ndbe_prog1-prob_ndbe_prog2))+((gerd_ns$gerd[i]*(1-prob_death[i]))*prob_gerd_prog1)
    gerd_ns$lgdbe[j] <- ((gerd_ns$lgdbe[i]*(1-prob_death[i]))*(1-prob_lgdbe_prog1-prob_lgdbe_prog2))+((gerd_ns$ndbe[i]*(1-prob_death[i]))*prob_ndbe_prog1)+((gerd_ns$gerd[i]*(1-prob_death[i]))*prob_gerd_prog2)
    gerd_ns$hgdbe[j] <- ((gerd_ns$hgdbe[i]*(1-prob_death[i]))*(1-prob_hgdbe_prog1-prob_hgdbe_prog2))+((gerd_ns$lgdbe[i]*(1-prob_death[i]))*prob_lgdbe_prog1)+((gerd_ns$ndbe[i]*(1-prob_death[i]))*prob_ndbe_prog2)
    ...
    gerd_ns$und_eac1_a[j] <- ((gerd_ns$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog1)+((gerd_ns$lgdbe[i]*(1-prob_death[i]))*prob_lgdbe_prog2)
    ...
    gerd_ns$eac2_a[j] <- ((((gerd_ns$und_eac1_a[i]+gerd_ns$und_eac1_b[i])*(1-prob_eac1_diag))+gerd_ns$und_eac1_c[i]+gerd_ns$und_eac1_d[i])*(1-prob_death[i])*prob_eac1_prog)+((gerd_ns$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog2)
  ...
  for (i in 1:12) {
    ...
    ndbe_s$ndbe[j] <- ((ndbe_s$ndbe[i]*(1-prob_death[i]))*(1-prob_ndbe_prog1-prob_ndbe_prog2))+((ndbe_s$gerd[i]*(1-prob_death[i]))*prob_gerd_prog1)
    ndbe_s$lgdbe[j] <- ((ndbe_s$lgdbe[i]*(1-prob_death[i]))*(1-((prob_lgdbe_prog1+prob_lgdbe_prog2)*(1-efficacy))))+((ndbe_s$ndbe[i]*(1-prob_death[i]))*prob_ndbe_prog1)+((ndbe_s$gerd[i]*(1-prob_death[i]))*prob_gerd_prog2)
    ndbe_s$hgdbe[j] <- ((ndbe_s$hgdbe[i]*(1-prob_death[i]))*(1-((prob_hgdbe_prog1+prob_hgdbe_prog2)*(1-efficacy))))+((ndbe_s$lgdbe[i]*(1-prob_death[i]))*prob_lgdbe_prog1*(1-efficacy))+((ndbe_s$ndbe[i]*(1-prob_death[i]))*prob_ndbe_prog2)
    ...
    ndbe_s$und_eac1_a[j] <- ((ndbe_s$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog1*(1-efficacy))+((ndbe_s$lgdbe[i]*(1-prob_death[i]))*prob_lgdbe_prog2*(1-efficacy)) # Added (1-efficacy)
    ...
    ndbe_s$eac2_a[j] <- ((((ndbe_s$und_eac1_a[i]+ndbe_s$und_eac1_b[i])*(1-prob_eac1_diag_s))+ndbe_s$und_eac1_c[i]+ndbe_s$und_eac1_d[i])*(1-prob_death[i])*prob_eac1_prog)+((ndbe_s$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog2*(1-efficacy)) # Added (1-efficacy)
  ...
  for (i in 1:12) {
    ...
    ndbe_ns$ndbe[j] <- ((ndbe_ns$ndbe[i]*(1-prob_death[i]))*(1-prob_ndbe_prog1-prob_ndbe_prog2))+((ndbe_ns$gerd[i]*(1-prob_death[i]))*prob_gerd_prog1)
    ndbe_ns$lgdbe[j] <- ((ndbe_ns$lgdbe[i]*(1-prob_death[i]))*(1-prob_lgdbe_prog1-prob_lgdbe_prog2))+((ndbe_ns$ndbe[i]*(1-prob_death[i]))*prob_ndbe_prog1)+((ndbe_ns$gerd[i]*(1-prob_death[i]))*prob_gerd_prog2)
    ndbe_ns$hgdbe[j] <- ((ndbe_ns$hgdbe[i]*(1-prob_death[i]))*(1-prob_hgdbe_prog1-prob_hgdbe_prog2))+((ndbe_ns$lgdbe[i]*(1-prob_death[i]))*prob_lgdbe_prog1)+((ndbe_ns$ndbe[i]*(1-prob_death[i]))*prob_ndbe_prog2)
    ...
    ndbe_ns$und_eac1_a[j] <- ((ndbe_ns$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog1)+((ndbe_ns$lgdbe[i]*(1-prob_death[i]))*prob_lgdbe_prog2)
    ...
    ndbe_ns$eac2_a[j] <- ((((ndbe_ns$und_eac1_a[i]+ndbe_ns$und_eac1_b[i])*(1-prob_eac1_diag))+ndbe_ns$und_eac1_c[i]+ndbe_ns$und_eac1_d[i])*(1-prob_death[i])*prob_eac1_prog)+((ndbe_ns$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog2) 
  ...
  for (i in 1:12) {
    ...
    lgdbe_s$lgdbe[j] <- ((lgdbe_s$lgdbe[i]*(1-prob_death[i]))*(1-((prob_lgdbe_prog1+prob_lgdbe_prog2)*(1-efficacy))))
    lgdbe_s$hgdbe[j] <- ((lgdbe_s$hgdbe[i]*(1-prob_death[i]))*(1-((prob_hgdbe_prog1+prob_hgdbe_prog2)*(1-efficacy))))+((lgdbe_s$lgdbe[i]*(1-prob_death[i]))*prob_lgdbe_prog1*(1-efficacy))
    ...
    lgdbe_s$und_eac1_a[j] <- ((lgdbe_s$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog1*(1-efficacy))+((lgdbe_s$lgdbe[i]*(1-prob_death[i]))*prob_lgdbe_prog2*(1-efficacy))
    ...
    lgdbe_s$eac2_a[j] <- ((((lgdbe_s$und_eac1_a[i]+lgdbe_s$und_eac1_b[i])*(1-prob_eac1_diag_s))+lgdbe_s$und_eac1_c[i]+lgdbe_s$und_eac1_d[i])*(1-prob_death[i])*prob_eac1_prog)+((lgdbe_s$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog2*(1-efficacy)) 
  ...
  for (i in 1:12) {
    ...
    lgdbe_ns$lgdbe[j] <- ((lgdbe_ns$lgdbe[i]*(1-prob_death[i]))*(1-prob_lgdbe_prog1-prob_lgdbe_prog2))
    lgdbe_ns$hgdbe[j] <- ((lgdbe_ns$hgdbe[i]*(1-prob_death[i]))*(1-prob_hgdbe_prog1-prob_hgdbe_prog2))+((lgdbe_ns$lgdbe[i]*(1-prob_death[i]))*prob_lgdbe_prog1)
    ...
    lgdbe_ns$und_eac1_a[j] <- ((lgdbe_ns$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog1)+((lgdbe_ns$lgdbe[i]*(1-prob_death[i]))*prob_lgdbe_prog2)
    ...
    lgdbe_ns$eac2_a[j] <- ((((lgdbe_ns$und_eac1_a[i]+lgdbe_ns$und_eac1_b[i])*(1-prob_eac1_diag))+lgdbe_ns$und_eac1_c[i]+lgdbe_ns$und_eac1_d[i])*(1-prob_death[i])*prob_eac1_prog)+((lgdbe_ns$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog2)
  ...
  for (i in 1:12) {
    ...
    hgdbe_s$hgdbe[j] <- ((hgdbe_s$hgdbe[i]*(1-prob_death[i]))*(1-((prob_hgdbe_prog1+prob_hgdbe_prog2)*(1-efficacy))))
    ...
    hgdbe_s$und_eac1_a[j] <- ((hgdbe_s$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog1*(1-efficacy))
    ...
    hgdbe_s$eac2_a[j] <- ((((hgdbe_s$und_eac1_a[i]+hgdbe_s$und_eac1_b[i])*(1-prob_eac1_diag_s))+hgdbe_s$und_eac1_c[i]+hgdbe_s$und_eac1_d[i])*(1-prob_death[i])*prob_eac1_prog)+((hgdbe_s$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog2*(1-efficacy))
  ...
  for (i in 1:12) {
    ...
    hgdbe_ns$hgdbe[j] <- ((hgdbe_ns$hgdbe[i]*(1-prob_death[i]))*(1-prob_hgdbe_prog1-prob_hgdbe_prog2))
    ...
    hgdbe_ns$und_eac1_a[j] <- ((hgdbe_ns$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog1)
    ...
    hgdbe_ns$eac2_a[j] <- ((((hgdbe_ns$und_eac1_a[i]+hgdbe_ns$und_eac1_b[i])*(1-prob_eac1_diag))+hgdbe_ns$und_eac1_c[i]+hgdbe_ns$und_eac1_d[i])*(1-prob_death[i])*prob_eac1_prog)+((hgdbe_ns$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog2)
  ...
  for (i in 1:12) {
    ...
    eac1_s$und_eac1_a[j] <- ((eac1_s$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog1*(1-efficacy))
    ...
    eac1_s$eac2_a[j] <- ((((eac1_s$und_eac1_a[i]+eac1_s$und_eac1_b[i])*(1-prob_eac1_diag_s))+eac1_s$und_eac1_c[i]+eac1_s$und_eac1_d[i])*(1-prob_death[i])*prob_eac1_prog)+((eac1_s$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog2)
  ...
  for (i in 1:12) {
    ...
    eac1_ns$und_eac1_a[j] <- ((eac1_ns$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog1)
    ...
    eac1_ns$eac2_a[j] <- ((((eac1_ns$und_eac1_a[i]+eac1_ns$und_eac1_b[i])*(1-prob_eac1_diag))+eac1_ns$und_eac1_c[i]+eac1_ns$und_eac1_d[i])*(1-prob_death[i])*prob_eac1_prog)+((eac1_ns$hgdbe[i]*(1-prob_death[i]))*prob_hgdbe_prog2)
